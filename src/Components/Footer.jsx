export const Footer = () => {
  return (
    <div  style={{backgroundColor:'#f4f4f4'}} className="d-flex justify-content-center  mt-5 ">
      <div  className="container ">
        <div className="row">
          <row className="col-md-2">
            <div>
              <ul>
                <li className="fw-bolder fs-4 Foot-text mt-5 mb-5" >Turo</li>
                <li className="mt-2 fw-bolder Foot-text" >About</li>
                <li className="mt-2 fw-bolder Foot-text" >Team</li>
                <li className="mt-2 fw-bolder Foot-text" >Policies</li>
                <li className="mt-2 fw-bolder Foot-text" >Careers</li>
                <li className="mt-2 fw-bolder Foot-text" >Press</li>
                <li className="mt-2 fw-bolder Foot-text" >OpenRoad</li>
                <li className="mt-2 fw-bolder Foot-text" >Turo Shop</li>
              </ul>
            </div>
          </row>
          <row className="col-md-2">
            <div>
              <ul>
                <li className="fw-bolder fs-4 mt-5 mb-5 fw-bolder Foot-text" >Locations</li>
                <li className="mt-2 fw-bolder Foot-text" >USA(EN)</li>
                <li className="mt-2 fw-bolder Foot-text" >Canada (EN)</li>
                <li className="mt-2 fw-bolder Foot-text" >Canada (FR)</li>
                <li className="mt-2 fw-bolder Foot-text" >UK (EN)</li>
              </ul>
            </div>
          </row>
          <row className="col-md-2">
            <div>
              <ul>
                <li className="fw-bolder fs-4 mt-5 mb-5 Foot-text" >Explore</li>
                <li className="mt-2 fw-bolder Foot-text" >Book a car</li>
                <li className="mt-2 fw-bolder Foot-text"  >Weddings</li>
                <li className="mt-2 fw-bolder Foot-text" >Trust</li>
                <li className="mt-2 fw-bolder Foot-text" >Sustainability</li>
                <li className="mt-2 fw-bolder Foot-text" >FAQs</li>
                <li className="mt-2 fw-bolder Foot-text" >Get help</li>
              </ul>
            </div> 
          </row>
          <row className="col-md-2">
            <div>
              <ul>
                <li className="fw-bolder fs-4 mt-5 mb-5 Foot-text" >Hosting</li>
                <li className="mt-2 fw-bolder Foot-text">List Your Car</li>
                <li className="mt-2 fw-bolder Foot-text" >Calculater</li>
                <li className="mt-2 fw-bolder Foot-text" >All Star-Host</li>
                <li className="mt-2 fw-bolder Foot-text " >Host tools</li>
                <li className="mt-2 fw-bolder Foot-text" >Insurance & protection</li>
                <li className="mt-2 fw-bolder Foot-text" >FAQs</li>
              </ul>
            </div>
          </row>
            ...
            <div>
              <div className="Foot-text" >
                <svg
                  ...
                  className="fw-bolder fs-5 mt-5 mb-5 seo-pages-0"
                  role="img"
                  version="1.1"
                >
                  <path
...
>
  ...
  viewBox="0 0 150 44"
  aria-hidden="true"
  className="mt-5 mb-5 seo-pages-0"
  role="img"
  version="1.1"
>
  <defs>
  ...
  <path d="M144.445 43.996H5.555C2.5 43.996 0 41.523 0 38.5V5.504C0 2.48 2.5.004 5.555.004h138.89c3.051 0 5.555 2.476 5.555 5.5V38.5c0 3.023-2.5 5.496-5.555 5.496zm0 0" />
  <path
  ...
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 24 24"
  className=" mt2 mb-5 seo-pages-0"
  height="24px"
  role="img"
  version="1.1"
  width="24px"
>
  <g data-name="Layer 2">
    <g data-name="Layer 1">
      <circle cx={12} cy={12} r={12} style={{ fill: "rgb(255, 255, 255)" }} />
      <path
        d="M17 22.91H7a11.88 11.88 0 0 0 9.94 0ZM2.34 19.1A12.13 12.13 0 0 0 4.12 21h15.76a12.13 12.13 0 0 0 1.78-1.94ZM11.81 13.4h12.1A10.85 10.85 0 0 0 24 12v-.54H11.81ZM.46 15.28a13 13 0 0 0 .75 1.94h21.58a13 13 0 0 0 .75-1.94ZM11.81 1.94h6.72A12 12 0 0 0 12 0h-.19ZM11.81 7.64v1.94h12a12.45 12.45 0 0 0-.59-1.94ZM11.81 3.82v1.94h10.43a11.7 11.7 0 0 0-1.48-1.94Z"
        style={{ fill: "rgb(208, 47, 68)" }}
      />
      <path
        d="M11.81 0a12 12 0 0 0-11 7.74h.12a.76.76 0 0 1 0 1.51A.74.74 0 0 1 .39 9 11.7 11.7 0 0 0 0 12a10.85 10.85 0 0 0 .09 1.4h11.72ZM2.58 11a.75.75 0 0 1 0-1.5.75.75 0 1 1 0 1.5Zm0-3.55a.75.75 0 1 1 .76-.75.76.76 0 0 1-.76.75Zm1.68 1.78a.76.76 0 0 1 0-1.51.76.76 0 0 1 0 1.51Zm0-3.56a.75.75 0 0 1 0-1.5.75.75 0 0 1 0 1.5ZM5.93 11a.75.75 0 0 1 0-1.5.75.75 0 1 1 0 1.5Zm0-3.55a.75.75 0 1 1 .76-.75.76.76 0 0 1-.76.75Zm0-3.55a.76.76 0 1 1 .76-.75.76.76 0 0 1-.76.75Zm1.68 5.33a.76.76 0 0 1 0-1.51.76.76 0 0 1 0 1.51Zm0-3.56a.75.75 0 0 1 0-1.5.75.75 0 1 1 0 1.5ZM9.28 11a.75.75 0 0 1 0-1.5.75.75 0 1 1 0 1.5Zm0-3.55A.75.75 0 1 1 10 6.7a.76.76 0 0 1-.72.75Zm0-3.55a.76.76 0 1 1 .72-.75.76.76 0 0 1-.72.75Z"
        style={{ fill: "rgb(70, 70, 127)" }}
      />
    </g>
  </g>
</svg>
